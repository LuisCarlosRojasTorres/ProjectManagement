...
- The project manager is responsible for planning, organizing, managing tasks, budgeting, controlling costs, and other factors to help keep the project within budget and on time. 
  ...
  ![alt text](/img/interpersonal-skills.png)
...
-  a project manager is not often the direct manager of the people working on a project team
   -   the project manager is someone who manages the tasks of a project
...
- So, your job isn't to be the expert on everything. Instead you're responsible for guiding your team and making sure that they have the support that they need in order to complete the project
- You have to:
  ...
  - undestand and help teammates to adopt the right workflows and project management styles.
  - collaborate with other teams at the organization to deliver solutions that meed the requirements based on project scope, schedule and budget.
...
![alt text](/img/cross-functional.png)
- Clarify goals
...
- Recognize efforts
  - Sometimes, when you work with cross-functional teams, there are certain skills that get recognized more than others. A mechanic could get accolades for coming up with the solution to a problem within the project, while the finance member who sourced the funding might be forgotten. As a project manager, it is your job to m**ake sure that each member of your cross-functional team recognizes the value of their efforts each step of the way**. You have learned the importance of building relationships with stakeholders, and building relationships with your cross-functional team members is just as important. Learning what makes your team members feel supported, giving and taking feedback, and being mindful of each individual's background, personal identifiers, and work style can help mediate some of the differences among team members. 
- Key takeaway
  - Being able to communicate clearly with team members, 
  - clarify the goals of the project, 
  - get team members with the right skills, 
  - measure team progress, and 
  - recognize team members’ efforts is an important part of your role as the project manager, and is key to your project’s success.
...
- Flexibility (when changes are needed is key)
...
- In the previous video, we discussed the four key competencies of a project manager: 
  ...
  - flexibility.   
- In this reading, we’ll dig deeper into **why flexibility is essential for effective project management** and **how you can help your team deal with ambiguity**. 
- **Enabling decision-making**
  - You can help team members feel empowered from the start of your project by **making the decision-making process collaborative**. For example, **state the goals of specific deliverables and elicit input from your team on how to achieve those goals**. 
  - You may have an idea of how you would like certain tasks to be accomplished, but **your team members may have more creative or efficient approaches** (mismo destino talvez camino diferente).
  - Empowering your team to express their opinions and make their own decisions **allows you to focus on the overarching management tasks and prioritize them in order of importance** (no es por ellos, es por mi). Additionally, when you allow team members to have a voice in decisions (por lo menos la sensacion de...), it helps foster an environment of responsibility, accountability, and team closeness (el poder de la sugestión...). 
- **Communicating and escalating**
  - Project management requires **clearly communicating project goals and expectations** (esto puede servir como una introduccion en la reunion de planeamiento), team member roles and responsibilities (pasamos a la importancia de cada uno de los miembros), and constructive feedback (sus fortalezas y de forma delicada los deslices). 
  - Knowing how to effectively communicate and when to escalate issues to management is key to keeping you (esta informacion es facilitada durante la daily), your team, and your organization on the path to success. 
  - When escalation is required, try to approach management with both **the problem and the potential solution or suggestions** (centrarse en la solución, el problema es temporal la solución es permanente). 
  - This will show that you’re taking initiative as a project manager (nunca un acusador, sino un facilitador). 
- **Strong organizational skills**
...
**Flexibility**
- All project managers need the **ability to adapt and overcome changes and challenges** (todos necesitan eso no solo los pm...). Let’s further explore why flexibility is such a critical project management skill and discuss how it can help prepare your team for change, mitigate risks, and handle ambiguity. 
  - **Flexible planning**
    - Change is inevitable, and the more flexible you are as a project manager, the more successful you will be throughout your career. These flexible planning strategies can help you manage your project **during times of unpredictability**: 
      ...
      - **Plan for risks and challenges**. If you consider the risks that may occur, you may be able to find solutions for them in advance. For example, **what if someone on your team gets sick or decides to quit?** (cada topico deberia tener dos personas involucradas). Are you able to replace them within the company? If not, can you hire an independent contractor? Come up with a list of people who may be able to join your team if one of your team members becomes unavailable. You can also assess risks by looking at historical data. Review your past projects and examine the challenges you faced. Then evaluate if similar challenges could occur in this project and prepare accordingly. We will discuss risk management at length later in this program.
